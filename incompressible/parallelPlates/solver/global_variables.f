        ...
        module global_variables
            ...
            ! Flow parameters
            real*8 Dt, nu, rho, mu, sigma, alpha, beta, Re, Ha, Rm, r, V_char, B_char, T0
            real*8 Bo_mag, Bo_slope, Bo_position
            real*8 :: e_g(3)

            ! State variables
            real*8, allocatable, dimension(:)   :: Var_old
            real*8, allocatable, dimension(:)   :: Bo_function
            ...
            integer :: Iter_count = 0, PISO_counter, CVP_counter
            real*8, allocatable, dimension(:)   :: Err_Vx, Err_Vy, Err_Vz, Err_p, Err_Bix, Err_Biy, Err_Biz, Err_T, Err_pr, Err_pr_v
